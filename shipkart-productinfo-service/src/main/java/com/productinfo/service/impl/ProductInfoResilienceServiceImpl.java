...
public class ProductInfoResilienceServiceImpl implements IProductInfoService {
	...
	@Override
	@CircuitBreaker(name = "info-service", fallbackMethod = "fallbackGetById")
	...
	public Type fallbackGetById(int productId,Throwable e) {
		System.out.println(e.getMessage());
		return new Failure("Technical error. try again ");
	}

	@Override
	@CircuitBreaker(name = "info-service", fallbackMethod = "fallbackGetByCat")
	...
	public List<Product> fallbackGetByCat(String category,Exception e) {
